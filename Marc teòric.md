...
En aquesta part de la memòria s'explicarà tot el necessari per a comprendre tot el que es conta en aquest treball. El lector trobarà elements conceptuals bàsics, estudis previs i la seua anàlisi per plantejar de quin punt de partida naix aquest treball. Llegir aquesta secció facilitarà la lectura de les següents i es contestarà el "per què" d'algunes decisions.
