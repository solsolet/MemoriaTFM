...
En aquesta part de la memòria s’explicarà tot el necessari per a comprendre què es conta en aquest treball. El lector trobarà elements conceptuals bàsics, estudis previs i la seua anàlisi per a plantejar des de quin punt de partida naix aquest projecte. Llegir aquesta secció facilitarà la lectura de les següents i es contestarà els “per què” d’algunes decisions.

Qualsevol qüestió que es considere susceptible d’ampliar, i continue sent rellevant per al treball, per tal de no fer-ne una lectura feixuga, estarà com a material de consulta en l’annex.
...
Aquest gènere també el podem trobar anomenat com a _background games_, _ambiental games_, jocs incrementals i ZPG (_Zero Player Games_). Aquest últim podríem considerar-lo un subtipus dels _idles_, ja que no cal l’input del jugador, el joc progressa soles.

**Característiques**:

- Interacció mitjançant *tap* o *clic* que permet guanyar punts.
- A cert nombre de punts pots pujar de nivell o adquirir una millora per a clicar, com per exemple l'automatització.
- Cada pujada o millora costa més.
...
L'èxit d'un joc *idle* rau en un bon disseny de la retenció, ja que es tracta de partides molt llargues, i per a aconseguir-ho s'ha de tenir una progressió balancejada.

Un recurs molt utilitzat és el **creixement exponencial**, ja que provoca una sensació de progrés molt ràpid al principi.

##### Musical

Els videojocs musicals són un gènere de videojoc completament orientat a la interacció de les accions del jugador sincronitzades amb la música que sona. Aquestes accions solen estar dins de la pulsació i al ritme de la música [@Building-a-music-rhythm-video-game, p. 1].

**Característiques**:

- Ritme: sol aparéixer visualment com un element interactuable si l'acciones en el moment exacte.
...
- Nivells de dificultat / puntuacions: es pot avaluar la teua execució de l'obra al final amb un veredicte o a cada encert recompensar-te puntuant.
- Indicació de precisió (perfecte, malament, regular...): segons l'execució si has encertat el ritme de manera més precisa on rebràs millor o pitjor puntuació.
- Sinestèsia: el ritme, a banda de sonorament, el podràs veure en diferents formes, colors...
...
Els videojocs no tenen ni un segle d’història, és per això que sorprén com han crescut en l’àmbit tècnic i econòmic de manera abrupta. Aquesta dinàmica encara es veu més accentuada en el mercat mòbil dels videojocs, molt més recent, i ha sobrepassat els seus antecessors: les consoles i el PC.

#### Història dels videojocs mòbils

Per a tenir una idea d’on partim, els primers jocs per a mòbils van més enllà de la tecnologia dels telèfons mòbils, sinó que de les consoles portàtils ja hi havia traces del que estava per venir. Tenim, per exemple, consoles com la _Game & Watch_ de Nintendo o els precursors dels mòbils, les PDA (_Personal Digital Assistants_). Aquestes últimes, a banda d’incloure funcionalitats d’agenda, llibreta per a prendre notes, calculadora, etc., podien incloure jocs, com ara _Sharp Wizard_, que tenia jocs com Tetris, escacs o backgammon.

En aquestes primeres instàncies els jocs venien inclosos en els dispositius, no calia fer un esforç per a tenir-los, com era el cas del *Snake* de Nokia, el 1997, que va estar en 350 milions de dispositius [@exploringMobileGameInteractions]. Van ser plataformes com *i-mode* al Japó, que permetien la descàrrega i es començava a conrear un interés per part de companyies desenvolupadores per aquest mercat, com Konami, Nintendo o Bandai entre altres [@edge1999mobiles].

Si ens situem en els 2000, per molt que l’interés existira, hi havia una gran limitació per diverses bandes del creixement d’aquest mercat:
...
- La limitació de les botigues d'aplicacions del moment en les interfícies altament textuals que dificultaven l'exploració fora dels primers títols que apareixien.
- Inferior qualitat d'experiències de videojocs respecte de les consoles portàtils.

Continuant cronològicament, l'impacte més gros en el programari mòbil i l'ecosistema dels jocs el trobem l'any 2007 i 2008, amb el llançament del primer iPhone i de l'App Store, respectivament [@mayra2015mobilegames]. No va ajudar directament a aquest mercat, sinó que va pal·liar totes les limitacions anteriors de manera que:
...
- Va esdevenir un dels estàndards en proliferar, per tant, molts desenvolupadors van apostar per aquesta tecnologia i plataforma.
...
Fet i fet, va propulsar el sector mòbil en tots els aspectes. Va ser tal el seu triomf, que va fer que una gran quantitat de la competència abandonara, llevat d’Android i altres menys rellevants.

Amb aquest context, jocs com _Angry Birds_, llançat en 2009, va arribar a l’App Store per un preu assequible per al consumidor, i això el va fer arribar al podi de les aplicacions de pagament als principis de la dècada de 2010. Prompte es va llançar la versió del joc per a Android de forma gratuïta, però amb anuncis, si no es pagava.

Molts altres grans títols es van llançar en aquesta dècada i van aplicar diverses tècniques de monetització que hui han servit de precedent, ja que encara s’usen assíduament.

D’altres jocs rellevants també van aportar a la consolidació d’aquest mercat i a l’atracció de públic, com va ser el cas de:

- _Candy Crush_, amb el seu model _freemium_ i la combinació amb xarxes socials.
- *Clash of Clans*, amb el seu aspecte multijugador.
- *Crossy Road* i similars, per portar el gènere hipercasual a la palestra.
- *Pokémon Go*, amb els seus trencadors rècords de jugadors i aconseguint tenir 100 milions de descàrregues en un mes de vida per la seua modalitat RA geolocalitzada addictiva.
- *Fortnite*, que va iniciar l'era dels jocs multiplataforma perquè arribara a dispositius mòbils.
- *Among Us*, pel seu auge durant la pandèmia i el seu component social.

Com a últim esdeveniment important que va donar un gran impuls al mercat, ens situem en la pandèmia, l'any 2020, que com a resultat del confinament, la gent es va abocar a jugar a videojocs. Al sector mòbil açò va repercutir en un increment del 40% [@impactCOVID19Mobile2020].

#### Públic

Els usuaris de dispositius mòbils es poden separar segons el SO que usen. Si es mira enrere fins hui dia, per exemple situant-nos l’any 2020 fins al 2026 (any en què es redacta aquest treball), la majoria usen Android (prop d’un 70%) i la resta iOS (vora el 30%) i la resta de SO no resulten significatius.
...
Aquests últims mesos es comença a veure un canvi en la tònica predominant que, encara que no es produïra, resulta interessant desenvolupar per als dos mercats. I no només cal prestar atenció al mercat d’iOS pel seu creixement, sinó també que, tot i ser molt menor, té majors vendes dins de les seues aplicacions.
...
Com s'ha explicat a la [metodologia](#sec-godot-451), Godot és un motor de videojocs 2D-3D de codi obert multiplataforma. Serà l’eina principal per a desenvolupar el videojoc, ja que ens permetrà exportar-lo tant a iOS com a Android, amb els ajustos que es determinen. A més, es poden afegir connectors que facilitaran el control de funcions de les botigues d’aplicacions.

No només resulta atractiu com a motor per cobrir les necessitats bàsiques del projecte, també ho resulta per ser de **codi obert** amb una llicència MIT [@GODOT_faq], que vol dir:

- És de descàrrega gratuïta i el motor es pot usar per a qualsevol finalitat, tant personal, sense ànim de lucre, comercial o altres.
- L'usuari és lliure de modificar, distribuir, redistribuir i mesclar Godot com vulga, per qualsevol raó, siga comercial o no.

A diferència dels altres motors comercials que predominen el mercat dels videojocs, com poden ser Unreal o Unity, que potser són idonis per a projectes més complexos i grans, per al cas d’un videojoc indie senzill de mòbil podrien considerar-se excessius, a més de fer els projectes més grossos i difícils d’utilitzar.

Godot, a més, després de la polèmica de Unity l’any 2023 de les tarifes per instal·lació i canvis en els termes i condicions, va créixer en popularitat. Per a fer memòria, el que va passar va ser que, segons la llicència i les vendes del desenvolupador i els canvis retroactius, van posar la comunitat en contra seua i es va plantejar buscar noves alternatives.

Unity és un motor de programari privatiu, per tant, no és mai del desenvolupador; aquests només tenen una llicència d’ús. Es troba en mans d’una corporació que mira pel seu interés propi, encara que això signifique degradar el servei, les condicions i perdre la confiança dels usuaris.

I per afegir-hi més motius: mesos abans de la polèmica, Godot va llançar la seua versió 4.0, en què s’afig i es millora suport gràfic 3D, com també altres funcionalitats i solucionar algunes errades. Aquest Godot va traient versions i, a dia de la redacció d’aquesta memòria, hi ha fins a la 4.7 llançada el juny de 2026.
...
Tots els videojocs analitzats disposen d'una qualificació per edat per a tots els públics.
...
Les versions en cada botiga són diferents.

#### Mecàniques i progressió

Es pot passar en una vesprada tranquil·lament. L’arquer llança fletxes a les dianes sense que el jugador haja de fer res; el que sí que pot decidir és en quines estadístiques se centra o quines millores adquireix.
...
- **Equipament**: millores que afecten les estadístiques i incrementen el seu percentatge. El preu es duplica en cada compra.
- **Noves habilitats**: la compra desbloqueja un tipus diferent de fletxa. Preu únic.
- **Talents**: millora alguna característica especial d'alguns tipus de fletxes. El preu es quadruplica en cada compra.
...
El joc té un estil *pixel art* on el personatge del jugador, l'arquer és molt xicotet i tota l'atenció de la pantalla està en la trajectòria de les fletxes i les dianes.

Es pot accedir als menús clicant en els botons per a mostrar-los i ocultar-los.
...
Els menús resulten un poc molestos perquè tapen la pantalla del joc i no s’acaben de veure les fletxes, que són l’únic atractiu visual fora del fons de bosc. Els jocs _idle_ —com es veurà a continuació— solen tenir una interfície on la botiga de millores es troba a la dreta sense interrompre en l’escena del joc.

![Captura de pantalla de Magic Archery. Font: itch.io](Memoria/Assets/AltresJocs/MagicArchery/MagicArchery-Joc.png){height=7cm}

Les fletxes quan impacten en la diana els apareix el dany que li han infringit amb el color del tipus de fletxa.

La música és relaxant i promou l’atmosfera màgica de bosc. Els efectes sonors al principi quan hi ha poques fletxes són agradables, però a mesura que se’n tenen moltes resulta molt molest. Cada fletxa sona diferent.

El joc està orientat a ordinadors i encara que la disposició en horitzontal en mòbil no acostume a ser un problema, tots els menús són prou xicotets per a no ser còmodes en pantalles xicotetes, per tant, convindria una adaptació.
...
S’hi pot jugar en la versió web gratuïta o en plataformes com Steam, PlayStation, Xbox, Switch i Android. En aquesta última trobem la versió gratuïta amb anuncis i la de pagament sense; entre les dues versions té més de 5 milions de baixades en la Play Store.

Sent un dels jocs més importants del gènere _idle_, resulta interessant analitzar com ha estat implementat. La versió mòbil és una adaptació de la versió web.

#### Mecàniques i progressió

El joc tracta d'anar guanyant galetes. Es poden gastar en:

- **Edificis**: ajudants que et proporcionen una quantitat de galetes per segon. De cada tipus d'edifici se'n poden tenir moltes unitats. N'hi ha fins a 20 tipus diferents.
- **Millores**: increments de la producció de galetes o de les estadístiques d'un tipus d'edifici. N'hi ha fins a 716 diferents.

Les galetes es poden guanyar fent **clic** en la galeta gegant o en les _galetes daurades_, a través dels teus _Edificis_ o per la quantitat de _Llet_. A mesura que s’avança en el joc, es desbloquejaran **assoliments**.

Una altra mecànica que hi ha és el **llegat**. Quan es guanya una certa quantitat de galetes es pot **ascendir**, que vol dir perdre el progrés, però es guanya en _fitxes celestials_ i _nivells de prestigi_, que porta a tenir millores permanents en la resta de partides.

La versió de navegador disposa d’altres mecàniques que tenen alguns dels seus edificis com ara: invertir en borsa amb els bancs, cultivar llavors amb la granja… També té _terrossos de sucre_ on pots guanyar-ne un diàriament. Aquestes mecàniques ajuden a guanyar més galetes i millorar la progressió. També fa el joc més interessant. Després d’estar un temps jugant en les dues versions, es podria considerar que la versió de navegador és més entretinguda i motiva a entrar-hi diàriament, cosa que la versió mòbil no propicia.

Per a progressar en el joc, s'ha d'anar comprant *Edificis* o *Millores*.

Cada *Edifici* té:

- Un preu base per al primer *edifici* i per cada nova compra augmenta el preu un 15%.
...
La progressió és més ràpida amb la versió mòbil, ja que sempre que tornes a l'aplicació, aquesta independentment estiga en *backgroud* o no, et diu moltes galetes has guanyat en la teua absència, mentre que al tancar el navegador i tornar, no passa això.

#### UI/UX

L’estil visual del joc és ximple. Els edificis, les millores i les icones tenen un estil píxel-art molt detallat.
...
En un monitor gran podem veure totes les seccions juntes. El detall en posar el ratolí damunt d’una millora o edifici es veu bé i la informació s’entén bé. Per altra banda, en un telèfon mòbil les seccions estan separades, el detall costa fer un clic i no posa el percentatge de la producció com ho fa el navegador.
...
| **Menú**     | Menú variat amb els botons per a veure: opcions, estadístiques, informació del joc i llegat | Tots en els botons en un mateix lloc                                                   | Desplegat en diferents apartats entre la pestanya de ”`Stats`” i ”`Misc`” |
...
| **Botiga**   | Mostra els articles que es poden comprar amb un clic d'Edificis i Millores.                 | Les millores en situar el ratolí es despleguen per a veure'n totes les disponibles     | Es separa en dues pantalles que permet desplaçar-te per la llista         |
...
El joc en la seua versió mòbil no té ni música de cap mena ni sons, només n'hi ha de dues classes:
...
Joc *indie* desenvolupat per [Raúl Moreno Tamayo](https://asdehielo.itch.io) publicat a itch.io el 2021. Tracta que un misteriós quadrat ha aparegut en ta casa i no fa res a banda de girar en el sentit de les agulles del rellotge. Gastaràs tots els teus estalvis assegurant-te que gire [@PushSquare].
...
- **Push**: espentes el quadrat. Quan completes una rotació muntarà el comptador corresponent.

Les **millores** que es poden adquirir ajuden a generar més diners, tant per clic com passivament, redueix la fricció en girar el quadrat, i això farà que vaja més de pressa, o s’afigen elements decoratius a la pantalla.

És un joc curt que es pot passar en menys de deu minuts, no hi ha moltes millores i eventualment es generen diners i voltes molt ràpides sense esforç, ja que es pot deixar polsat el botó. El fet que siga curt no li lleva la gràcia, les millores són absurdes i es veu com la pantalla va omplint-se de ninots que fan una festa mentre es gira el quadrat. És un exemple absurdament condensat del gènere _idle_ i funciona perfectament: fan ganes de jugar-hi per a veure fins on arriba.

#### UI/UX

El joc té un estil _píxel art_ senzill, com també una interfície simple amb la botiga a la dreta com _Cookie clicker_. En les millores que pots comprar hi ha una descripció del que fan.
...
_Rhythm Paradise_ és un videojoc musical, de ritme a l’estil Wario Ware, és a dir, com una sèrie de minijocs. Aquests videojocs posen a prova el sentit del ritme del jugador i normalment va lligat amb la memòria. D’aquest tipus, Nintendo compta amb predecessors com la sèrie _Guitar Hero_, _In the Groove_ o _Rock Band_. I de la casa trobem _Donkey Konga_, _Elite Beats Agents_ o _ElectroPlankton_, entre altres.

El videojoc va ser llançat al Japó el 31 de juliol de l’any 2008 amb el nom de _Rhythm Tengoku Gold_, que vol dir _Rhythm Heaven Gold_. A la resta del món es va comercialitzar en altres dates. A l’Amèrica del Nord, el 5 d’abril del 2009; a Austràlia, el 4 de juny amb el nom de _Rhythm Heaven_, i a Europa, l’1 de maig del mateix any amb el nom de _Rhythm Paradise_, que és com s’anomenarà en aquest cas.

Molts d’aquests videojocs van de bracet amb una trama íntegrament musical o lligada a un instrument, cosa que _Rhythm Paradise_ no. Incorpora la música com un acompanyant de l’acció del minijoc, com puga ser jugar al ping-pong o collir fruita.

El videojoc va ser llançat per a la Nintendo DS. El seu predecessor, _Rhythm Tengoku_, per a la Game Boy Advance i altres títols de la sèrie han sigut per a Wii o Wii U com la continuació _Rhythm Heaven Fever_. La presència del joc en diferents consoles que evolucionen amb el temps, és un indicatiu que les mecàniques es poden replicar en diferents contextos tecnològics.

Va tenir una gran rebuda, de totes les pàgines que puguem consultar de rànquings de videojocs, veurem que la seua qualificació sempre és un notable. Com ara a _Metacritic_, que té un 83 sobre 100, en _Famitsu_ un 34/40 o 9 de 10 estrelles en _Wired_.
...
És una mecànica molt senzilla, però efectiva, no cal tenir molta destresa.

#### UI/UX

El videojoc planteja diferents espais, majorment bidimensionals, a excepció dels minijocs _A Escala_, _Peloteo Rítmico_ i _Aerosurf_, que estan en 3D.
...
Pel menú (una vegada ens passem els 15 primers minijocs) es pot lliscar cap avall i mostrarà 15 minijocs més per a jugar, i en superar-los es permetrà anar cap a l’esquerra o la dreta, on n’hi haurà 20 més en total.
...
Perquè un jugador diga que s’ha “passat el joc”, a banda d’haver superat els 50 minijocs, es pot continuar perfeccionant puntuacions fins a tenir un **Genial** en cadascun i, per què no anar més lluny?, un **Perfecte** en tots. Després ja no quedarà gran cosa per fer.
...
Les **portades** tenen un estil més lliure, pot ser més geomètric, tenir diferents composicions, usar degradats… Mentre que els **jocs** tenen un _sprites_ _cartoon_ ximples, on els personatges i escenaris tenen unes línies i figures ben definides, pintats segons la paleta del nivell.
...
Els _Remix_ —com tornem a veure les escenes dels minijocs que en formen part i escoltem les seues músiques—, l’estil de cada aparició s’integra en l’estètica comuna. En el cas d’aquest tercer, tenen una estètica tradicional japonesa, en què veurem personatges amb quimono i flors de cirerer, mentre els personatges es mouen al ritme de la música tenyits dels colors morats i grocs.

Cal destacar també que, tenint en compte que el joc és per a la Nintendo, l’acció es veu en la pantalla superior de la consola i el jugador interacciona en la inferior, la tàctil. En aquesta última només veurem un punter redó en tocar la pantalla amb l’stylus amb els colors de la paleta del nivell.

#### Música i so

Tractant-se d’un joc de ritme, la música té un paper fonamental. Les peces, repartides entre els minijocs, han de ser d’una longitud similar, atractives a l’oïda i tenir alguna dificultat rítmica perquè esdevinguen un repte. Sense deixar de costat que han de ser diferents i originals per a no tenir la sensació d’estar jugant tota l’estona amb la mateixa música.

Hi ha minijocs que tenen una cançó amb lletra i d’altres que no. Segons el que s’estiga percudint, el disseny sonor s’adapta; per exemple en _Peloteo Rítmico_, la pilota de ping-pong sona com una de veritat quan la veus rebotar o la colpeges.

Com analitzar-les totes és molt extens, només destacaré el minijocs analitzats anteriorment: _Aves Marciales_ i _Remix 3_. La particularitat dels _Remix_, com el seu nom indica, són un nivell on trobem els motius rítmics i música dels minijocs de la seua columna d’una manera que tenen una instrumentació i estètica diferent i uniforme.
...
S’ha fet una anàlisi breu sobre una partitura:
...
La presentació de la pantalla d’inici dels _Remix_ està fet a l’estil 8 bit. La cançó en si és una **barreja d’estils**, com puga ser tango, jazz, copla o folk.

Se senten trompetes, un saxo, una carraca, una esquella, plats, piano, flautes… el que podria ser una mena de _big band_.
...
En la primera part escoltem la trompeta acompanyada del que podria ser la _big band_, després dona pas al solo de saxo mentre el jugador fa tresets.
...
De tota manera, tant la part de trompeta o la de saxo estan en La m, al canvi al vent fusta es produeix una modulació a la dominant, Mi m. Després torna a la tònica i acaba.
